<?php
require_once 'connection.php';//pravimo niz u kome smestamo poruke o nevalidno popunjenoj formi
$errMsg = [];//proveravamo da li smo na stranicu dosli POST metodom
...
if ($_SERVER["REQUEST_METHOD"] == "POST") 
{
    ...
    if (!empty($broj_telefona))
    {
        ...
        {
            $errMsg['broj_telefona'] = 'Polje email nije validno.';
        }
    }
    ...
    if (count($errMsg) == 0) 
    {
        ...
        ('" . $ime . "', '" . $prezime . "', "
            . ($email ? ("'" . $email . "'") : 'null') . ", "
            . ($broj_telefona ? ("'" . $broj_telefona . "'") : 'null') . ");";        $r = $conn->query($q);
        if ($r) 
        {
...
<html lang="en"><head>
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/js/bootstrap.bundle.min.js"></script>    <title>Unos</title>
                    ...
                    <div class="card-body">
                        <form action="#" method="post"> <!-- forma salje podatke istoj stranici POST metodom -->
                            <div class="form-group mb-3">
                                ...
                                value="<?php echo $ime; ?>"> <!-- vrednost atributa NAME mora da bude jedinstveno na nivo forme jer je to klju u asocijativnom nizu kada se preuzmu parametri -->
